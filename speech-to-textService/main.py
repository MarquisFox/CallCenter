...
def main():
    ...
    processor = AudioProcessor(model_size=config.WHISPER_MODEL_SIZE)

    def process_url(file_url: str) -> str:
        return processor.process_audio_from_url(file_url)

    try:
        kafka_service.run(process_url)
